...
- /sets: https://github.com/dfinke/powershell-algorithms/tree/master/src/algorithms/sets
    - https://github.com/dfinke/powershell-algorithms/tree/master/src/algorithms/sets/longest-common-subsequnce

- /string:
    - https://github.com/dfinke/powershell-algorithms/tree/master/src/algorithms/string/levenshtein-distance
    - https://github.com/dfinke/powershell-algorithms/tree/master/src/algorithms/string
